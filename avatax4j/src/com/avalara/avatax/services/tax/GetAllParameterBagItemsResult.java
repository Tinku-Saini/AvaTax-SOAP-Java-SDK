 ...
 */
public class GetAllParameterBagItemsResult extends com.avalara.avatax.services.tax.BaseResult  implements java.io.Serializable {
    private com.avalara.avatax.services.tax.ArrayOfParameterBagItem parameterBagItems;

    /**
     * Initializes a new instance of the class.
     */
    public GetAllParameterBagItemsResult() {
    }

    private GetAllParameterBagItemsResult(com.avalara.avatax.services.tax.ArrayOfParameterBagItem parameterBagItems) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://avatax.avalara.com/services", "GetAllParameterBagItemsResult"));
