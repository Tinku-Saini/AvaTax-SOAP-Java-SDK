...
public class ArrayOfMessage  implements java.io.Serializable {
    private com.avalara.avatax.services.account.Message[] message;

    public ArrayOfMessage() {
    }

    public ArrayOfMessage(
           com.avalara.avatax.services.account.Message[] message) {
     ...
     * @return message
     */
    public com.avalara.avatax.services.account.Message[] getMessage() {
        return message;
    }
     ...
     * @param message
     */
    public void setMessage(com.avalara.avatax.services.account.Message[] message) {
        this.message = message;
    }

    public com.avalara.avatax.services.account.Message getMessage(int i) {
        return this.message[i];
    }

    public void setMessage(int i, com.avalara.avatax.services.account.Message _value) {
